...
复制 [index.js](https://raw.githubusercontent.com/gaoyunzhi/jsproxy/master/cf-worker/index.js) 到左侧代码框，`Save and deploy`。如果正常，右侧应显示首页。
...
默认情况下，静态资源从 `https://gaoyunzhi.github.io/jsproxy` 反向代理，可通过代码中 `ASSET_URL` 配置，从而可使用自定义的 `conf.js` 配置。
