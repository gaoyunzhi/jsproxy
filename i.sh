...
SRC_URL=https://raw.githubusercontent.com/gaoyunzhi/jsproxy/$JSPROXY_VER
BIN_URL=https://raw.githubusercontent.com/gaoyunzhi/jsproxy-bin/master
ZIP_URL=https://codeload.github.com/gaoyunzhi/jsproxy/tar.gz
...
main() {
  ...
  log "安装完成。后续维护参考 https://github.com/gaoyunzhi/jsproxy"
}
